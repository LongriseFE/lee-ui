<template>
  <label
    class="lee-checkbox-button"
      :class="[
        size ? 'lee-checkbox-button-' + size : '',
    ...
    <input
      ...
      class="lee-checkbox-button-original"
      type="checkbox"
      :name="name"
      :disabled="isDisabled"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      size() {
        return this._checkboxGroup.checkboxGroupSize || this._leeFormItemSize || (this.$ELEMENT || {}).size;
      },
